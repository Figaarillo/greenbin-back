...
export class Migration20241103165427 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "wastes" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "category_id" uuid not null, "points" int not null, "weight" int not null, "points_per_weight" int not null, constraint "wastes_pkey" primary key ("id"));');
    ...
    this.addSql('create table "wastes_transactions" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "responsible_id" uuid not null, "neighbor_id" uuid not null, "green_point_id" uuid not null, "total_points" int not null, "date" timestamptz not null, constraint "wastes_transactions_pkey" primary key ("id"));');

    this.addSql('create table "wastes_transactions_details" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "waste_id" uuid not null, "points_per_weight" int not null, "points" int not null, "transaction_id" uuid not null, constraint "wastes_transactions_details_pkey" primary key ("id"));');
